...
SWFUpload.prototype.getFlashHTML = function() {
	return [ '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="', this.movieName,
...
SWFUpload.prototype.cleanUp = function(a) {
	try {
		if (this.movieElement && typeof (a.CallFunction) === "unknown") {
			...
			for ( var c in a) {
				try {
					if (typeof (a[c]) === "function" && a[0] >= 'A' && a[0] <= 'Z') {
						a[c] = null
					}
				} catch (b) {
				}
...
/*
 * Uploadify v3.2.1 Copyright (c) 2012 Reactive Apps, Ronnie Garcia Released
